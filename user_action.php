...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
        ...
        while($row = mysqli_fetch_array($combinequery))
		{
			...
			<button type="button" name="delete_button" class="btn btn-danger btn-circle btn-sm delete_button" data-id="'.$row["user_id"].'" data-status="'.$row["user_status"].'"><i class="fas fa-times"></i></button>
			</div>';
			$data[] = $sub_array;
		}
